...
function Signup() {
  ...
  return (
    ...
    >
      <div className="absolute bg-black opacity-60 inset-0 z-0 h-full"></div>
      <div
        className="w-full max-w-xl p-4 sm:p-7 bg-white rounded-lg z-10"
      ...
      >
        ...
        <h2 className="text-2xl font-bold  my-8 text-white">
          Create New Account
        </h2>
        <form onSubmit={handleSubmit}>
          <div className="mb-4 sm:mb-7">
            ...
            <input
              className="w-full px-3 py-2  rounded focus:outline-none    bg-black sm:p-4 text-white "
              id="fullName"
              name="fullName"
              type="text"
          ...
          <div className="mb-4 sm:mb-7">
            ...
            <select
              className="w-full px-3 py-2 text-gray-400  rounded focus:outline-none    bg-black sm:p-4"
              id="department"
              name="department"
          ...
          <div className="mb-4 sm:mb-7">
            ...
            <select
              className="w-full px-3 py-2 text-  rounded focus:outline-none    bg-black sm:p-4  text-gray-400 "
              id="region"
              name="region"
          ...
          <div className="mb-4 sm:mb-7">
            ...
            <input
              className="w-full px-3 py-2 text-white  rounded focus:outline-none   bg-black sm:p-4"
              id="confirmPassword"
          ...
          <div className="text-center">
            <button
              className="w-full px-4 py-2 text-white  rounded    bg-indigo-500 hover:bg-indigo-600 focus:outline-none"
              type="submit"
            >
              Sign Up
            </button>
