            ...
            >
              <div className="pb-2 pt-4">
                <input
                  ...
                  required
                  className="block w-full p-4 text-lg rounded-sm bg-black outline-none"
                />
              </div>
              <div className="pb-2 pt-4">
                <input
              ...
              <div className="px-4 pb-2 pt-4">
                <button
                  className="uppercase block w-full sm:p-4 p-3 sm:text-lg text-base rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none"
                  type="submit"
                >
                  sign in
                </button>
